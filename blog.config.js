...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'hexo', // 主题， 支持 ['next','hexo',"fukasawa',] @see https://preview.tangly1024.com
  ...
  AUTHOR: 'Linn in korea', // 您的昵称 例如 tangly1024
  BIO: '열심히 사는 일반인🍚', // 作者简介
  LINK: 'https://tangly1024.com', // 网站地址
  KEYWORDS: '중식, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'chenghubnb1@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK: 'https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-model-tororo
